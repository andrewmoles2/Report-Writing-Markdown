...
For this workshop we will be using [Quarto](https://quarto.org/), which is a new (2022) piece of software built on R Markdown and designed to bring some quality of life improvements from R Markdown. Quarto works in the same way as R Markdown, so if you know one you will know both. 

![Artwork by @allison_horst](https://cdn.myportfolio.com/45214904-6a61-4e23-98d6-b140f8654a40/4898fb61-98e9-4923-8725-6813d4de2d82_rw_1920.png?h=f630a201b70bb08cd37af0606f10cc47)

## Outcomes

By the end of this workshop you will:

* Start using Quarto (R Markdown) in RStudio
* Create a document in Quarto (R Markdown) that includes
  - titles
  - sections
  - images
  - outputs from code
...
We will need to install [Quarto](https://quarto.org/docs/get-started/), select the installer which matches your device (Windows or Mac). Then follow the installation instructions. 

Once you have installed Quarto, open RStudio run the below command to make sure the package is installed and loaded. 
...
Some side notes on the side note is that there are other ways to define chunk options. Rather than write them here, the author of R Markdown has written about these in his [excellent documentation](https://yihui.org/knitr/options/) and the [Quarto documentation](https://quarto.org/docs/computations/r.html#chunk-options) details how chunk options can be different in Quarto to R markdown. 
...
You can change the referencing style to whatever you need and the [R Markdown book](https://bookdown.org/yihui/rmarkdown-cookbook/bibliography.html) or [Quarto documentation](https://quarto.org/docs/authoring/footnotes-and-citations.html) provide a guide to this. 
...
<https://lse.eu.qualtrics.com/jfe/form/SV_ewXuHQ1nRnurTdY?coursename=Report%writing%with%R%Markdown&topic=LaTeX&prog=SR&version=22-23&link=https://github.com/andrewmoles2/gender_pay_gap_example>

## What's next?

Have a go at the take home challenge, or set your own challenge like converting a report or document you've previously written into Quarto/R Markdown or LaTeX. You can try and use Quarto/R Markdown or LaTeX for reports you write this year which is great opportunity to learn. 
