...
If you have not done so already knit your document again so we can see the changes we made! Remember we press the **knit** button (or press `shift+command/control+k`) to compile our document with Quarto. You should see that the list of figures has appeared with an entry, yay!
